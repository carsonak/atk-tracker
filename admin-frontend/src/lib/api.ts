...
export async function fetchLive(): Promise<LivePresence[]> {
...
export async function fetchStats(apprenticeId: string, from: string, to: string): Promise<{ raw: HistoricalPoint[]; summary: HistoricalPoint[] }> {
